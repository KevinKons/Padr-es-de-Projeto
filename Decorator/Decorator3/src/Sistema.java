...
//
        Sanduiche xSuperBurguer = new Pao(new Queijo(new Hamburguer(new Queijo(new Hamburguer(new Pao(sanduiche))))));
...
//
        ...
        Sanduiche duploCostelaComBacon = new Pao(new Bacon(new Queijo(new HamburguerDeCostela(new Bacon(new Queijo(new HamburguerDeCostela(new Pao(new SanduicheFechado()))))))));
        System.out.println(duploCostelaComBacon);
        System.out.println(duploCostelaComBacon.getPreco());
    }
